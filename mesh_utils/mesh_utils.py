...
from mesh_utils.render_utils import save_img_f32, save_img_u8
...
class GaussianExtractor(object):
    ...
    @torch.no_grad()
    def reconstruction(self, render, viewpoint_stack, config, background, scene):
        """
        ...
        for i, viewpoint_cam in tqdm(enumerate(self.viewpoint_stack), desc="reconstruct radiance fields"):
            ...
            render_pkg = render(viewpoint_cam, config.opt.iterations, scene, config.pipeline, background,
    ...
    def estimate_bounding_sphere(self):
        ...
        """
        from mesh_utils.render_utils import transform_poses_pca, focus_point_fn
